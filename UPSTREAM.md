...
Updates use **GitHub Releases** on this fork, not upstream’s R2/Apple pipeline. This fork ships **Windows x86_64 only**.
...
| Workflow | `.github/workflows/release.yml` on `v*` tags (Windows NSIS only) |
