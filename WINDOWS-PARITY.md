...
| Harness/PTY kill | process group SIGTERM then SIGKILL | Job Object kill-on-close plus `taskkill /T` escalate | 1TO1 |
| Default terminal | `$SHELL` else zsh/bash | `pwsh` / `powershell -NoLogo` else `COMSPEC` | 1TO1 |
